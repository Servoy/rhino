...
public class BreakPoint {
    ...
    protected BreakPoint(Map<?, ?> options) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj == null || !(obj instanceof BreakPoint)) return false;
    ...
    /**
     * Used as a key in {@link BreakPointManager} callNames and returnNames The method {@link
     * DBGPDebugFrame#getWhere()} is used as a lookup key
     */
