        ...
        NewState execute(Context cx, CallFrame frame, InterpreterState state, int op) {
                ...
                if (lhs instanceof Scriptable || rhs instanceof Scriptable) {
                    ...
                    if (lNum instanceof BigInteger && rNum instanceof BigInteger) {
                        ...
                        throw ScriptRuntime.typeErrorById("msg.cant.convert.to.number", "BigInt");
                    	 ...
                    	 frame.stack[state.stackTop] =  ScriptRuntime.toBigDecimal(lNum).add(ScriptRuntime.toBigDecimal(rNum));
                  }  else {
                        frame.stack[state.stackTop] = DOUBLE_MARK;
            ...
            if (lhs instanceof Scriptable) {
                ...
                if (lNum instanceof BigInteger) {
    				...
    				frame.stack[state.stackTop] = ScriptRuntime.toBigDecimal(lNum).add(ScriptRuntime.toBigDecimal(d));
                } else {
                    frame.stack[state.stackTop] = DOUBLE_MARK;
